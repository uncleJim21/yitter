...
// Load ScraperAPI key from environment variable
...
async function callYitter(data) {
  return new Promise((resolve, reject) => {
    ...
    const command = `yt-dlp -vU -f ${format} -g --no-warnings --proxy http://api.scraperapi.com?api_key=${scraperAPIKey} https://www.youtube.com/watch?v=${videoId}`;
